#ifndef _ROS_am_soft_grip_msgs_StopCommand_h
#define _ROS_am_soft_grip_msgs_StopCommand_h
...
namespace am_soft_grip_msgs
{
  ...
  class StopCommand : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "am_soft_grip_msgs/StopCommand"; };
