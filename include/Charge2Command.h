#ifndef _ROS_tehislihas_Charge2Command_h
#define _ROS_tehislihas_Charge2Command_h
...
namespace tehislihas
{
  ...
  class Charge2Command : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "tehislihas/Charge2Command"; };
